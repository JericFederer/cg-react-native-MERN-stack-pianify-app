import { getAutoGeneratedPlaylist, getFollowersProfile, getFollowingsProfile, getPublicPlaylist, getPublicProfile, getPublicUploads, getRecommendedByProfile, getUploads, updateFollower } from "#/controllers/profile";
